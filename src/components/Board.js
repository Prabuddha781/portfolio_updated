...
const Board = () => {
  ...
  let actualSize =
    width > 1025 ? 0.33 * width : width < 992 ? 0.6 * width : 0.3 * width;
  ...
  return (
    <main className="d-flex flex-column ms-auto me-auto mt-auto mb-auto">
      <div
        className="text-light fst-italic mb-2"
        style={{ maxWidth: `${actualWidth * row}px` }}
      >
        Click on two cells in the board and run the algorithm.
      </div>
      ...
      <div className="mb-3 mt-3">
        <button
          className={`${classes.button10} me-3 mb-md-0 mb-2 mt-md-0 mt-2 align-self-center`}
          onClick={callBiBFS}
